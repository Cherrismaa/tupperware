...
const Contact = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Contact Us | Tupperware Store India</title>
        <meta
          name="description"
          content="Reach out to Tupperware Store India for product support, warranty, and wholesale enquiries. Visit our Hyderabad store or send us a quick message."
        />
        <link
          rel="canonical"
          href="https://tupperwarestore.co.in/contact"
        />
      </Helmet>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:contact@tupperware-india.com"
                        className="font-medium hover:text-primary transition-smooth"
                      >
              ...
              <Card className="shadow-medium">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    Rahamath Nagar Main Road, Yousufguda, Hyderabad, Telangana,
                    India
                  </p>
